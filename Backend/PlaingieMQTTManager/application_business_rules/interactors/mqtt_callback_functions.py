...
def on_connect(mqtt_client, user_data, flags, rc):
    ...
    """
    mqtt_client.subscribe(HOME_BACKYARD_LIGHT_1_COMMAND_LIGHT_SWITCH)
    mqtt_client.subscribe(HOME_BACKYARD_LIGHT_1_COMMAND_OPERATING_MODE)
    mqtt_client.subscribe(HOME_BACKYARD_LIGHT_1_COMMAND_VISIBILITY)
    mqtt_client.subscribe(HOME_BACKYARD_LIGHT_1_LIGHT_DATA)
    mqtt_client.subscribe(HOME_BACKYARD_LIGHT_SENSOR_1_LIGHT_SENSOR_DATA)
    mqtt_client.subscribe(HOME_BACKYARD_MOTION_SENSOR_1_MOTION_SENSOR_DATA)
    mqtt_client.subscribe(HOME_BACKYARD_SERVO_1_COMMAND_CURRENT_POSITION)
    mqtt_client.subscribe(HOME_BACKYARD_SERVO_1_COMMAND_START_POSITION)
    mqtt_client.subscribe(HOME_BACKYARD_SERVO_1_SERVO_DATA)
