...
"""
ACTIVATION_DISTRIBUTION = os.getenv('ACTIVATION_DISTRIBUTION')
ACTIVATION_REQUEST = os.getenv('ACTIVATION_REQUEST')
ACTIVATION_RESPONSE = os.getenv('ACTIVATION_RESPONSE')
